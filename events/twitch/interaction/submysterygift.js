 ...
 */
exports.event = (client, channel, username, numbofSubs, recipient, methods, userstate) => {
    ...
    // message for Action
    client.clients.logger.info(`${username} gifted ${recipient} a subscription.${numbofSubs} Sub`);
};