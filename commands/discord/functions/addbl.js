...
exports.run = async (client, message, args) => {
    ...
    message.channel.send(`"${blword}" wurde in die "${action}" Blacklist von ${client.config.watchtimechannel} eingetragen ;3`);
    client.clients.logger.info(`* Added "${blword}" to the ${action} Blacklist of ${client.config.watchtimechannel}`);
};